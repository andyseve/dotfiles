# Generated by Powerlevel10k configuration wizard on 2023-02-15 at 03:08 EST.
...
() {
  ...
  function prompt_command_new_execution_time() {
	if [[ $_p9k__refresh_reason == precmd ]]; then
	  local cur_exit_code=$?
	  p10k segment -f 208 -i '⭐' -t "$_p9k__status"
	fi
  }
